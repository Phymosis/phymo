...
<html lang="en" class="no-js dark-mode">
    <head>
        ...
        <title>Intro 11 | Defend the Web</title>
    ...
    <a href="/index.php" class="logo">Defend the Web</a>
    
           <ul class="breadcrumb">
                            <li><a href='/playground'>Playground</a></li>
                            <li><a href='/playground/intro12'>Intro 11</a></li>
                    </ul>
    ...
    <div class="sidebar-content">
        ...
        <div class="row">
            ...
            <div class="12 columns level-description">
                <p>I received a weird message from the main dev of the website. He talked about an hidden page at the root of this site. I also remember the number 64 but don't know what it means. He told me that <strong> thispageisheretobehacked</strong></code></p>
