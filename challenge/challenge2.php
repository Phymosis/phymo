...
<html lang="en" class="no-js dark-mode">
    <head>
        ...
        <title>Intro 2 | Defend the Web</title>
        ...
        <meta name="theme-color" content="#2d3b4f">
                    ...
                    <meta name="csrf-token" content="d805e2e46f8e8c9ddcf66358cca53194231d945da311bb96902ae8490e690c57">
    ...
    <a href="/dashboard" class="logo">Defend the Web</a>
           ...
           <ul class="breadcrumb">
                            ...
                            <li><a href='/playground/intro2'>Intro 2</a></li>
                    </ul>
            ...
            action="/search"            method="POST"            enctype="multipart/form-data"
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="3e3ddcc9a03dadb46e3e6fb214591af74164bdf6116a63c873b5bdb3cad70f28" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="formid">
                                                                                            ...
                                                                                            <input type="hidden" name="formid" id="formid" value="deb30ba1704bdc6ba88f46dd59354eb3" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
            ...
            <button type="submit" class="button button--main right"><i class="fas fa-search"></i></button>
                    ...
                    <li class="label">
                                ...
                                Playground
                                            ...
                                            <div class="right small">1 of 60</div>
                                        </div>
                                                                                                </a>
                                            </li>
                                    </ul>
            ...
            <div class="eight columns">
                <div class="block">
                    <div class="block-heading block-heading--secondary">
                                                    <div class="right">
                                <a href='/playground/intro4' class="next-level">Next level <i class="fas fa-angle-right"></i></a>
                            </div>
                                                <h1>
                            Intro 2
                                                    </h1>
        ...
        <form action="verif.php"
            class="form--main-2"
                    ...
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="9770165c40b17905ae58bc5d5b65d479abacdec856811a04b1ff5d1e795feb85" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--text " data-group="username">
                            ...
                            <label for="usernameChal">Username <span style='color: rgba(0,0,0,0)'>is rumchicken</span></label>                            
                        ...
                        <div class="input input--password " data-group="password">
                            ...
                            <label for="passwordChal">Password <span style='color: rgba(0,0,0,0)'>is 104417453a</span></label>                            
            ...
            <div class="four columns">
                <div class="block level-stats level-stats--progress">
                        ...
                        <div class="block">
                            <h3>90% <span class="small">pass rate</span></h3>
<div class="progress progress--small">
    <div class="progress-bar" style="width: 90%"></div>
</div>
<div class="right small" title="completed vs attempted">339,412 of 378,235</div>                        </div>
    ...
    $(function() {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Started',
                    data: ["28","28","50","25","11","2"],
                    lineTension: 0,
                    fill: false,
                    pointRadius: 0
                }, {
                    label: 'Passed',
                    data: ["11","18","38","20","8","3"],
                    lineTension: 0,
                    fill: false,
                    pointRadius: 0,
                    borderColor: '#4caf50'
            ...
            <div class="profile-card-details">
                <a href="https://defendtheweb.net/profile/johnathan" >
                    <h2>Johnathan Barrett</h2>
                                    ...
                                    <p><span title='05/01/2008 23:53 (UTC)'>13 years ago</span></p>
                            </div>
                                    ...
                                    <div class="block">
                        <div class="block-content">
                            Last completed by <a href='https://defendtheweb.net/profile/tfghc3vcb'  data-profile-card='tfghc3vcb'>tfghc3vcb</a> <span title='31/10/2021 09:27 (UTC)'>4 hours ago</span>
                        </div>
                    </div>
                
                <div class="button-group  mobile-hide">
                                            <!-- <a class="button button--wide" href="/discussions/playground-help/new?level=2">View discussions</a> -->
                                        <a class="button button--wide" href="/help/contact?message=There is an issue with level &quot;Intro 2%22">Report issue</a>
                </div>
            </div>
        </div>
