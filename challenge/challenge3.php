...
<html lang="en" class="no-js dark-mode">
    <head>
        ...
        <title>Intro 3 | Defend the Web</title>
        ...
        <script type='text/javascript'> $(function(){ $('.level form').submit(function(e){ e.preventDefault(); if(document.getElementById('password').value == correct) { document.location = 'verifJs3.php?pass=' + correct; } else { alert('Incorrect password') } })})</script>
        
                
                    <meta name="site-websocket" content="zhr3.co.uk/push">
        
                    <meta name="csrf-token" content="cb49fc6195daab84be137b6e02a5cbfb295e78c0b98e72f682319fec3a99adfe">
    ...
    <a href="/dashboard" class="logo">Defend the Web</a>
           ...
           <ul class="breadcrumb">
                            ...
                            <li><a href='/playground/intro3'>Intro 3</a></li>
                    </ul>
            ...
            action="/search"            method="POST"            enctype="multipart/form-data"
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="ff4dc40d819e43437aafc4330186ad919fef29ff5295149a9b081c5ce38bc3b0" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="formid">
                                                                                            ...
                                                                                            <input type="hidden" name="formid" id="formid" value="eb8ce1866efe93b385b9786fc751f9bd" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
            ...
            <div class="eight columns">
                <div class="block">
                    <div class="block-heading block-heading--secondary">
                                                    <div class="right">
                                <a href='/playground/intro2' class="next-level">Next level <i class="fas fa-angle-right"></i></a>
                            </div>
                                                <h1>
                            Intro 3
                                                            / Javascript
                        ...
                        <span class="user-status">
                            ...
                            <span>Completed</span>
                                                            <span title='31/10/2021 15:41 (UTC)'>3 hours ago</span> <span class="c-subtle">/</span> 
                                2 hours to complete
                                                    </span>
                    </div>
        ...
        <form
            class="form--intro-3"
                    ...
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="45bb062b9484a69e9c5f9d17ed45a8dbb68a3b5266b6087d50b99d2d3ab2e35d" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="formid">
                                                                                            ...
                                                                                            <input type="hidden" name="formid" id="formid" value="67ce243964287a723ff472c9bbcef1b5" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
            ...
            <div class="four columns">
                <div class="block level-stats level-stats--progress">
                        ...
                        <div class="block">
                            <h3>57% <span class="small">pass rate</span></h3>
<div class="progress progress--small">
    <div class="progress-bar" style="width: 57%"></div>
</div>
<div class="right small" title="completed vs attempted">33,583 of 59,255</div>                        </div>
    ...
    $(function() {
        ...
        var myChart = new Chart(ctx, {
            ...
            <div class="profile-card-avatar">
                <a href="https://defendtheweb.net/profile/thedlw">
            ...
            <div class="profile-card-details">
                <a href="https://defendtheweb.net/profile/thedlw" >
                    <h2>thedlw</h2>
                                    ...
                                    <p><span title='10/02/2008 22:56 (UTC)'>13 years ago</span></p>
                            </div>
                                    ...
                                    <div class="block">
                        <div class="block-content">
                            Last completed by <a href='https://defendtheweb.net/profile/gojolifo'  data-profile-card='gojolifo'>gojolifo</a> <span title='31/10/2021 17:59 (UTC)'>an hour ago</span>
                        </div>
                    </div>
                
                <div class="button-group  mobile-hide">
                                            <!-- <a class="button button--wide" href="/discussions/playground-help/new?level=33">View discussions</a> -->
                                        <a class="button button--wide" href="/help/contact?message=There is an issue with level &quot;Intro 3%22">Report issue</a>
                </div>
            </div>
        </div>
    ...
    <div class="cookies">
        ...
        <script>var correct = '10288f4473';</script>    </body>
</html>
