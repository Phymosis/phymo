...
<html lang="en" class="no-js dark-mode">
    <head>
        ...
        <title>Intro 4 | Defend the Web</title>
        ...
        <meta name="theme-color" content="#2d3b4f">
                    ...
                    <meta name="csrf-token" content="4327ee01d78d48da21ede5d7909ccd88c107281867b428408bc41cee82cc7c69">
    ...
    <a href="/dashboard" class="logo">Defend the Web</a>
           ...
           <ul class="breadcrumb">
                            ...
                            <li><a href='/playground/intro4'>Intro 4</a></li>
                    </ul>
            ...
            action="/search"            method="POST"            enctype="multipart/form-data"
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="4b686215525b1f40fbdf9eb216a3ac75a51d89a861fea09fae103503f1f98613" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="formid">
                                                                                            ...
                                                                                            <input type="hidden" name="formid" id="formid" value="89e8f6a0c3a50034e297e161e2807be8" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
            ...
            <div class="eight columns">
                <div class="block">
                    <div class="block-heading block-heading--secondary">
                                                    <div class="right">
                                <a href='/playground/intro5' class="next-level">Next level <i class="fas fa-angle-right"></i></a>
                            </div>
                                                <h1>
                            Intro 4
                                                    </h1>
                        <span class="user-status">
                            ...
                            <span>In progress</span>
                                                            <span class="c-subtle">/</span> Started <span title='31/10/2021 15:38 (UTC)'>3 minutes ago</span>
                                                    </span>
                    </div>
        ...
        <form action="verif.php"
            class="form--main-4"
                    ...
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="9058319004af96671e3356844cfe5bbbae0725add2ec264a8f57cc787aff37a8" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="passwordfile">
            ...
            <div class="four columns">
                <div class="block level-stats level-stats--progress">
                        ...
                        <div class="block">
                            <h3>86% <span class="small">pass rate</span></h3>
<div class="progress progress--small">
    <div class="progress-bar" style="width: 86%"></div>
</div>
<div class="right small" title="completed vs attempted">231,218 of 269,386</div>                        </div>
            ...
            <div class="profile-card-details">
                <a href="https://defendtheweb.net/profile/johnathan" >
                    <h2>Johnathan Barrett</h2>
                                    ...
                                    <p><span title='05/01/2008 23:55 (UTC)'>13 years ago</span></p>
                            </div>
                                    ...
                                    <div class="block">
                        <div class="block-content">
                            Last completed by <a href='https://defendtheweb.net/profile/tfghc3vcb'  data-profile-card='tfghc3vcb'>tfghc3vcb</a> <span title='31/10/2021 09:32 (UTC)'>6 hours ago</span>
                        </div>
                    </div>
                
                <div class="button-group  mobile-hide">
                                            <!-- <a class="button button--wide" href="/discussions/playground-help/new?level=9">View discussions</a> -->
                                        <a class="button button--wide" href="/help/contact?message=There is an issue with level &quot;Intro 4%22">Report issue</a>
                </div>
            </div>
        </div>
