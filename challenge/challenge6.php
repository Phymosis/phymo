...
<html lang="en" class="no-js dark-mode">
    <head>
        ...
        <title>Intro 6 | Defend the Web</title>
        ...
        <meta name="theme-color" content="#2d3b4f">
                    ...
                    <meta name="csrf-token" content="984a00cb51c789d52b87c74008d2fe3c63d06e379868460953f4e1c254390b0d">
    ...
    <a href="/dashboard" class="logo">Defend the Web</a>
           ...
           <ul class="breadcrumb">
                            ...
                            <li><a href='/playground/intro6'>Intro 6</a></li>
                    </ul>
    ...
    <div class="sidebar-content">
            ...
            action="/search"            method="POST"            enctype="multipart/form-data"
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="6d9c582e9c2c7363c16d6a2ace56f1c53dde858d92091afd24a804852d27b3a1" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="formid">
                                                                                            ...
                                                                                            <input type="hidden" name="formid" id="formid" value="464a781435e8385a3dea6af2b96ca6e2" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
        ...
        <div class="row">
            <div class="eight columns">
                <div class="block">
                    <div class="block-heading block-heading--secondary">
                                                    <div class="right">
                                <a href='/playground/intro7' class="next-level">Next level <i class="fas fa-angle-right"></i></a>
                            </div>
                                                <h1>
                            Intro 6
                                                    </h1>
            ...
            <div class="12 columns level-description">
                Login as boy_vs_girl to complete the level
            </div>
        </div>
            ...
            class="form--main-6"
                    ...
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="24187a875e685b643b45cb725df4f8ea8948c58936b8bbc15d85f3d28d692a12" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>

                        
                    
                        <div class="input input--select " data-group="username">
                            

                            <label for="username">Username</label>                            

                                                            <select name="usernameChal" id="usernameChal">
                                                                            <option value="jTman" >jTman</option>
                                                                            <option value="HammerSpace" >HammerSpace</option>
                                                                            <option value="F93338" >F93338</option>
                                                                            <option value="admin" >admin</option>
                                                                    </select>
                                                    </div>

                        <div class="input input--hidden " data-group="password">
                            

                                                        

                                                                                            <input type="hidden" name="passwordChal" id="passwordChal" value="e" maxlength="1" placeholder="" class="u-full-width" />
                                                    </div>
...
<div class="right small" title="completed vs attempted">192,077 of 203,759</div>                        </div>
            ...
            <div class="profile-card-details">
                <a href="https://defendtheweb.net/profile/johnathan" >
                    <h2>Johnathan Barrett</h2>
                                    ...
                                    <p><span title='06/01/2008 00:03 (UTC)'>13 years ago</span></p>
                            </div>
                                    ...
                                    <div class="block">
                        <div class="block-content">
                            Last completed by <a href='https://defendtheweb.net/profile/eescobar'  data-profile-card='eescobar'>eescobar</a> <span title='31/10/2021 17:37 (UTC)'>an hour ago</span>
                        </div>
                    </div>
                
                <div class="button-group  mobile-hide">
                                            <!-- <a class="button button--wide" href="/discussions/playground-help/new?level=11">View discussions</a> -->
                                        <a class="button button--wide" href="/help/contact?message=There is an issue with level &quot;Intro 6%22">Report issue</a>
                </div>
            </div>
        </div>
