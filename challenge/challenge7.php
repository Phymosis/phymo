...
<html lang="en" class="no-js dark-mode">
    <head>
        ...
        <title>Intro 7 | Defend the Web</title>
        ...
        <meta name="theme-color" content="#2d3b4f">
                    ...
                    <meta name="csrf-token" content="26f645e445bb2c2422544ab6f82b790f7c03f0c13557ee968c0d03e4eec96fbe">
    ...
    <a href="/dashboard" class="logo">Defend the Web</a>
           ...
           <ul class="breadcrumb">
                            ...
                            <li><a href='/playground/intro7'>Intro 7</a></li>
                    </ul>
    ...
    <div class="sidebar-content">
            ...
            action="/search"            method="POST"            enctype="multipart/form-data"
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="2e6b6ca97b9befa11e57a526fb890aa8c6477d4892f55874a993d9a13f28a380" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="formid">
                                                                                            ...
                                                                                            <input type="hidden" name="formid" id="formid" value="e5b7cac71abcf4ed4f4fd5d8255bc700" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
        ...
        <div class="row">
            <div class="eight columns">
                <div class="block">
                    <div class="block-heading block-heading--secondary">
                                                    <div class="right">
                                <a href='/playground/intro8' class="next-level">Next level <i class="fas fa-angle-right"></i></a>
                            </div>
                                                <h1>
                            Intro 7
                                                    </h1>
            ...
            <div class="12 columns level-description">
                <p>You couldn’t even find the password using a search engine as search bots have been excluded.</p>
        ...
        <form action="verif.php"
            class="form--intro-7"
                    ...
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="62164ad0ecf901070ff229057b0284038c272864fbc9716a28d293bcce184436" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
            ...
            <div class="four columns">
                <div class="block level-stats level-stats--progress">
                        ...
                        <div class="block">
                            <h3>89% <span class="small">pass rate</span></h3>
<div class="progress progress--small">
    <div class="progress-bar" style="width: 89%"></div>
</div>
<div class="right small" title="completed vs attempted">164,682 of 185,477</div>                        </div>
            ...
            <div class="profile-card-details">
                <a href="https://defendtheweb.net/profile/lordmoocow" >
                    <h2>Sammy</h2>
                                    ...
                                    <p><span title='07/01/2008 18:23 (UTC)'>13 years ago</span></p>
                            </div>
                                    ...
                                    <div class="block">
                        <div class="block-content">
                            Last completed by <a href='https://defendtheweb.net/profile/eescobar'  data-profile-card='eescobar'>eescobar</a> <span title='31/10/2021 17:49 (UTC)'>an hour ago</span>
                        </div>
                    </div>
                
                <div class="button-group  mobile-hide">
                                            <!-- <a class="button button--wide" href="/discussions/playground-help/new?level=12">View discussions</a> -->
                                        <a class="button button--wide" href="/help/contact?message=There is an issue with level &quot;Intro 7%22">Report issue</a>
                </div>
            </div>
        </div>
