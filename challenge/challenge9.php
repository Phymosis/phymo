...
<html lang="en" class="no-js dark-mode">
    <head>
        ...
        <title>Intro 9 | Defend the Web</title>
        ...
        <script type='text/javascript'>document.thecode = 'code123'; $(function(){ $('.level form').submit(function(e){ e.preventDefault(); if(document.getElementById('password').value == document.thecode) { document.location = 'verifJs9.php?pass=' + document.thecode; } else { alert('Incorrect password') } })}); </script>
        
                
                    <meta name="site-websocket" content="zhr3.co.uk/push">
        
                    <meta name="csrf-token" content="019ea3c847e55d4042684033b8a7df63b5d6c856536ed79c98e3d2fac46ac117">
    ...
    <a href="/dashboard" class="logo">Defend the Web</a>
           ...
           <ul class="breadcrumb">
                            ...
                            <li><a href='/playground/intro10'>Intro 9</a></li>
                    </ul>
            ...
            action="/search"            method="POST"            enctype="multipart/form-data"
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="a9834b302dc177f95efcbb7d34c0a1e260c1f354a5ddb0fadec4b65e97ec0108" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="formid">
                                                                                            ...
                                                                                            <input type="hidden" name="formid" id="formid" value="c3c372dcee7591c6b0fd3cc470daa97c" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
            ...
            <div class="eight columns">
                <div class="block">
                    <div class="block-heading block-heading--secondary">
                                                    <div class="right">
                                <a href='/playground/sqli1' class="next-level">Next level <i class="fas fa-angle-right"></i></a>
                            </div>
                                                <h1>
                            Intro 9
                                                            / Javascript
        ...
        <form
            class="form--intro-10"
                    ...
                    >
                        ...
                        <div class="input input--hidden " data-group="token">
                                                                                            ...
                                                                                            <input type="hidden" name="token" id="token" value="bfaac08aa6b1955b1b41cac74841ccf3e12e7557abcc4d9bb00b9894125d3771" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
                        ...
                        <div class="input input--hidden " data-group="formid">
                                                                                            ...
                                                                                            <input type="hidden" name="formid" id="formid" value="b0c4198ce7395a668882059314af00d0" maxlength="" placeholder="" class="u-full-width" />
                                                    </div>
            ...
            <div class="four columns">
                <div class="block level-stats level-stats--progress">
                        ...
                        <div class="block">
                            <h3>71% <span class="small">pass rate</span></h3>
<div class="progress progress--small">
    <div class="progress-bar" style="width: 71%"></div>
</div>
<div class="right small" title="completed vs attempted">19,921 of 27,961</div>                        </div>
    ...
    $(function() {
        ...
        var myChart = new Chart(ctx, {
            ...
            <div class="profile-card-avatar">
                <a href="https://defendtheweb.net/profile/the.almighty">
                    <img src='https://zhr3.co.uk/uploads/lazy/916a906d42618bb6304d81b743a659a6' data-lazy-image-size='avatar' width='80' class='' />
                </a>
            </div>
            <div class="profile-card-details">
                <a href="https://defendtheweb.net/profile/the.almighty" >
                    <h2>The.Almighty</h2>
                                            ...
                                            <span class="small">[The.Almighty]</span>
                                    </a>

                                    <p><span title='02/11/2008 20:04 (UTC)'>13 years ago</span></p>
                            </div>
                                    ...
                                    <div class="block">
                        <div class="block-content">
                            Last completed by <a href='https://defendtheweb.net/profile/gustavo11'  data-profile-card='gustavo11'>gustavo11</a> <span title='31/10/2021 18:11 (UTC)'>an hour ago</span>
                        </div>
                    </div>
                
                <div class="button-group  mobile-hide">
                                            <!-- <a class="button button--wide" href="/discussions/playground-help/new?level=35">View discussions</a> -->
                                        <a class="button button--wide" href="/help/contact?message=There is an issue with level &quot;Intro 10%22">Report issue</a>
                </div>
            </div>
        </div>
    ...
    <div class="cookies">
        ...
        <script type='text/javascript'>document['thecode'] = '\x37\x66\x36\x39\x61\x36\x31\x64\x32\x62'</script>    </body>
</html>
